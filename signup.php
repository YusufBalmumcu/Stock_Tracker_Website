...
<div class="form-container">
    <form action="signedup.php" method="POST">
        ...
        <input type="text" id="lastname" name="lastname" placeholder="Soyisim">
        <input type="text" id="gsm" name="gsm" placeholder="GSM">
        <input type="date" id="birthdate" name="birthdate" placeholder="Doğum Tarihi">
